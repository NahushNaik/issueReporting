<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/pages/UserMaster.master" CodeFile="Frm_Departmentwise_Drilldown.aspx.cs" Inherits="pages_Frm_Departmentwise_Drilldown" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body1" runat="Server">
    <a class="navbar-brand" href="#">Department Wise Reports</a>
</asp:Content>
                        ...
                        <div class="row" style="margin-top: 0px !important;">
                            <div class="col-md-12">
                                <div class="card" style="overflow: scroll;">
                                    ...
                                    <asp:Label ID="lblDapartment" Font-Bold="true" Font-Size="30px" runat="server" Text="0"></asp:Label>
                                    <br />
 ...
 <tr>
              ...
              <br />
                                           ...
                                           <telerik:radgrid id="rgvDetails" runat="server" allowfilteringbycolumn="true"  AutoGenerateColumns="false"  OnNeedDataSource="rgvDetails_NeedDataSource" Skin="Simple"  ActiveItemStyle-Wrap="true" cellspacing="-1" gridlines="Both" OnItemDataBound="rgvDetails_ItemDataBound" ItemStyle-BackColor="LightGray" AlternatingItemStyle-BackColor="LightGray" >
                                            <GroupingSettings CollapseAllTooltip="Collapse all groups" CaseSensitive="false"></GroupingSettings>
                                                  <ExportSettings Excel-Format="ExcelML" ExportOnlyData="true" IgnorePaging="true" FileName=" Department Open Tickets Report">
                                </ExportSettings>
                                            <MasterTableView CommandItemDisplay="Top">
                                                ...
                                                <Columns>
                                                 <telerik:GridHyperLinkColumn  HeaderStyle-Font-Bold="true" DataNavigateUrlFields="Ticket_Id" 
                                   DataNavigateUrlFormatString="ManageTicket.aspx?id={0}" HeaderText="Id" AutoPostBackOnFilter="true"  ItemStyle-Font-Bold="true" ItemStyle-HorizontalAlign="Center"   HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle"  ItemStyle-ForeColor="CadetBlue" ItemStyle-Font-Size="Larger" FilterCheckListEnableLoadOnDemand="true" DataTextField="Ticket_Id" ItemStyle-Font-Underline="true" DataType="System.String" ></telerik:GridHyperLinkColumn>
                                 ...
                                 <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Center" DataType="System.String"   DataField="createdDays" HeaderText="Created before(Days)" ItemStyle-HorizontalAlign="Center" ></telerik:GridBoundColumn>
              ...
              <br />
                                           ...
                                           <telerik:radgrid id="rgClosedTicket" runat="server" allowfilteringbycolumn="true"  AutoGenerateColumns="false"  OnNeedDataSource="rgClosedTicket_NeedDataSource" Skin="Simple"  ActiveItemStyle-Wrap="true" cellspacing="-1" gridlines="Both" OnItemDataBound="rgClosedTicket_ItemDataBound" ItemStyle-BackColor="LightGray" AlternatingItemStyle-BackColor="LightGray" >
                                            <GroupingSettings CollapseAllTooltip="Collapse all groups" CaseSensitive="false"></GroupingSettings>
                                                    <ExportSettings Excel-Format="ExcelML" ExportOnlyData="true" IgnorePaging="true" FileName=" Department Close Tickets Report"> </ExportSettings>
                                            <MasterTableView CommandItemDisplay="Top" >
                                                  <CommandItemSettings ShowExportToCsvButton="false" ShowRefreshButton="false" ShowAddNewRecordButton="false" ShowExportToExcelButton="true" />
                                                <Columns>
                                               

                                                     <telerik:GridBoundColumn Visible="true" HeaderStyle-HorizontalAlign="Center"  DataField="Ticket_Id" HeaderText="Id" ItemStyle-HorizontalAlign="Center"  ></telerik:GridBoundColumn>
                                                      <telerik:GridBoundColumn Visible="true" HeaderStyle-HorizontalAlign="Center"  DataField="Status" HeaderText="Status"  ></telerik:GridBoundColumn>
                                               <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Center" DataField="userName" HeaderText="User"   ></telerik:GridBoundColumn>
                                 ...
                                 <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Center"   DataField="Priority" HeaderText="Priority"  ></telerik:GridBoundColumn>
                               <%--  <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Center"  DataField="Created_Time" HeaderText="Created Time"  ></telerik:GridBoundColumn>
                                                    ...
                                                    <telerik:GridDateTimeColumn DataField="Updated_Time" AllowFiltering="true" HeaderText="Closed At" FilterControlWidth="100px"
