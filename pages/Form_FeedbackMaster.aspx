...
<asp:Content ID="Content2" ContentPlaceHolderID="Body1" runat="Server">
    ...
    <asp:Label ID="Label20" runat="server" meta:resourcekey="Label20Resource1" Text="User Feedback"></asp:Label>
    </a>&nbsp;
</asp:Content>
                        ...
                        <div class="row" style="margin-top: 0px !important;">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="header">
                                        <h4 class="title">
                                            <asp:Label ID="Label19" runat="server" meta:resourcekey="Label19Resource1" Text="User Feedback"></asp:Label>
                                        </h4>
                                    ...
                                    <div class="content table-responsive table-full-width">
                                          <telerik:radgrid id="rgUserFeedback" runat="server" allowfilteringbycolumn="True" AutoGenerateColumns="False"  OnNeedDataSource="rgUserFeedback_NeedDataSource" Skin="Simple"  ActiveItemStyle-Wrap="true"  cellspacing="-1" gridlines="Both" ItemStyle-BackColor="LightGray" AlternatingItemStyle-BackColor="LightGray" FilterItemStyle-CssClass="text-center" meta:resourcekey="rgUserFeedbackResource1"   >
                                            <GroupingSettings CollapseAllTooltip="Collapse all groups" CaseSensitive="false"></GroupingSettings>
                                                <ExportSettings Excel-Format="ExcelML" ExportOnlyData="true" IgnorePaging="true" FileName="User Feedback Report" > 
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                      ...
                                                      <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Center" DataField="userName" HeaderText="Ticket Owner" Visible="false"  DataType="System.String" meta:resourcekey="GridBoundColumnResource7" >
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                      </telerik:GridBoundColumn>
