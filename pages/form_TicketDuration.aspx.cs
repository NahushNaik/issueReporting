...
public partial class pages_form_TicketDuration : System.Web.UI.Page
{
    string fromTime = "";
    string toTime = "";
    string tStatus;
    ...
    private void fnCallDates(string type)
    {
        ...
        if (type == "recent")
        {
            ...
            dtpFromDate.SelectedDate = Convert.ToDateTime(System.DateTime.Now.ToShortDateString() + " 00:00:01");
            dtpToDate.SelectedDate = Convert.ToDateTime(System.DateTime.Now.ToShortDateString() + " 23:59:59");
        ...
        else if (type == "withinWeek")
        {
            ...
            dtpFromDate.SelectedDate = Convert.ToDateTime(System.DateTime.Now.AddDays(-3).ToShortDateString() + " 00:00:01");
            dtpToDate.SelectedDate = Convert.ToDateTime(System.DateTime.Now.AddDays(-1).ToShortDateString() + " 23:59:59");
        ...
        else if (type == "MoreThanWeekOpen")
        {
            ...
            dtpFromDate.SelectedDate = Convert.ToDateTime(System.DateTime.Now.AddDays(-365).ToShortDateString() + " 00:00:01");
            dtpToDate.SelectedDate = Convert.ToDateTime(System.DateTime.Now.AddDays(-4).ToShortDateString() + " 23:59:59");
