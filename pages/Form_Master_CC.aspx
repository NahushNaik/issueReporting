...
<asp:Content ID="Content3" ContentPlaceHolderID="Body2" runat="Server">
    <div class="content">
                    <div class="container-fluid">
                        <div class="row" style="margin-top: 0px !important;">
                            <div class="col-md-12">
                             ...
                             <telerik:RadGrid RenderMode="Lightweight" ID="rgCC" runat="server" AllowPaging="true" AllowSorting="true" AllowFilteringByColumn="true" AutoGenerateColumns="false" OnNeedDataSource="rgCC_NeedDataSource" OnItemCreated="rgCC_ItemCreated" GroupingSettings-CaseSensitive="false" AllowAutomaticUpdates="false" AllowAutomaticInserts="false" OnItemCommand="rgCC_ItemCommand" OnInsertCommand="rgCC_InsertCommand" OnUpdateCommand="rgCC_UpdateCommand"    Skin="MetroTouch">
                ...
                <MasterTableView ClientDataKeyNames="CC_Id" InsertItemPageIndexAction="ShowItemOnFirstPage" EditMode="InPlace" CommandItemDisplay="Top" DataKeyNames="CC_Id"  >
                    ...
                    <Columns >
                        <telerik:GridTemplateColumn DataField="CC_Id" HeaderText="Id" UniqueName="CC_Id" HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="left"  Visible="false" DataType="System.String" >
                            <ItemTemplate>
                                <%# Eval("CC_Id") %>
                            </ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn DataField="CC_Email_Id" HeaderText="CC Email Id" UniqueName="CC_Email_Id" HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="left" DataType="System.String" >
                            ...
                            <EditItemTemplate>
                                ...
                                <telerik:RadTextBox RenderMode="Lightweight"  runat="server" ID="txtEmail" Text='<%#Eval("CC_Email_Id") %>' >
                                    <ClientEvents  />
                                </telerik:RadTextBox>
