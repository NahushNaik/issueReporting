...
<asp:Content ID="Content2" ContentPlaceHolderID="Body1" runat="Server">
    <a class="navbar-brand" href="#">
        <asp:Label ID="Label1" runat="server" Text="Type Wise Reports" meta:resourcekey="Label1Resource1"></asp:Label></a>
</asp:Content>
                                            ...
                                            <GroupingSettings CollapseAllTooltip="Collapse all groups" CaseSensitive="False"></GroupingSettings>
                                                    ...
                                                    <MasterTableView CommandItemDisplay="Top">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <telerik:GridBoundColumn DataField="Type_Name" FilterControlAltText="Filter Type_Name column" HeaderText="Type" meta:resourcekey="GridBoundColumnResource3" UniqueName="Type_Name" Visible="False">
                                                            </telerik:GridBoundColumn>
                                              ...
                                              <Excel Format="ExcelML" />
                                                    ...
                                                    <MasterTableView CommandItemDisplay="Top">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <telerik:GridBoundColumn DataField="Type_Name" FilterControlAltText="Filter Type_Name column" HeaderText="Type" meta:resourcekey="GridBoundColumnResource12" UniqueName="Type_Name" Visible="False">
                                                            </telerik:GridBoundColumn>
