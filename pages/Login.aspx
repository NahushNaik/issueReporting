                            ...
                            <div class="box">
                                <div class="content">
                                    ...
                                    <div class="error">
                                        ...
                                        <asp:Label ID="lblError" runat="server" Text="Invalid user name or password..." Visible="False" Font-Bold="True" ForeColor="Red" meta:resourcekey="lblErrorResource1"></asp:Label>
                                    </div>
